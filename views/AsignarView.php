...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <span style="margin-left: 1%">Asignacion de Cursos</span>
        </nav>
        <!-- /.navbar -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="labelAsignarCurso">Asignar Curso(s)</h1>
                                            <button
                                                type="button"
                                                class="btn-close"
                                        ...
                                        <form action="index.php" method="post">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div>
                                                    <label for="nombreCur" class="form-label">Aprendiz: </label>
                                                    <br />
                                                    <input
                                                        class="form-control"
                                                        type="text"
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="2">¡No hay asignaciones de cursos existentes!</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
